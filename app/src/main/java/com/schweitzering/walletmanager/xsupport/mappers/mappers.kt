...
fun TransactionProfile.toTransaction() = Transaction(value = value, date = date, description = description, category = category, categoryType = categoryType)
fun Transaction.toTransactionProfile() = TransactionProfile(value = value, date = date, description = description, category = category, categoryType = categoryType)
...
fun FixedExpenseGeneratorProfile.toFixedExpenseGenerator() = FixedExpenseGenerator(id, expense, creationDate, schedule)
fun FixedExpenseGenerator.toFixedExpenseGeneratorProfile() = FixedExpenseGeneratorProfile(id, expense, creationDate, schedule)
